...
|------|---------|-------------|
| `settings.py` | JSON 配置管理器 | `BaseJsonManager`, `SettingsManager`, `CacheManager`, `ShelfToolsSettingsManager` (收藏/筛选/额外shelf路径/备注延迟), `ShelfToolsCacheManager` (图标/备注/标签), `BuiltinToolsCacheManager` |
